...
public class MapPractice2 {
    public static void main(String[] args) {
        ...
        System.out.println(listOfMaps.size()); //5
        ...
        for (Map<String, Object> eachMap : listOfMaps) { // Maps --> Map
            for (Map.Entry<String, Object> eachEntry : eachMap.entrySet()) { //Map--> key and value
